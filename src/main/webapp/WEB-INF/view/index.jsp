		...
		<div class="section-margin">
			<div class="flex-between">
				<div class="icon-container">
					...
					<span class="icon-text">물놀이가자</span>
				</div>
				<div class="icon-container">
					...
					<span class="icon-text">만만한캠핑</span>
				</div>
				<div class="icon-container">
					...
					<span class="icon-text">키즈캠핑</span>
				</div>
				<div class="icon-container">
					<a
			...
			<div class="flex-between section-margin">
				<div class="icon-container">
					...
					<span class="icon-text">오토캠핑</span>
				</div>
				<div class="icon-container">
					<a href=""><button class="button-c button-icon">
							<i class="fa-solid fa-campground icon-size"></i>
						</button></a> <br />
					<span class="icon-text">글램핑</span>
				</div>
				<div class="icon-container">
					<a href=""><button class="button-c button-icon">
							<i class="fa-solid fa-caravan icon-size"></i>
						</button></a> <br />
					<span class="icon-text">카라반</span>
				</div>
				<div class="icon-container">
					...
					<span class="icon-text">펜션</span>
				</div>
				<div class="icon-container">
					<a href=""><button class="button-c button-icon">
							<i class="fa-solid fa-gift icon-size"></i>
						</button></a> <br />
					<span class="icon-text">이벤트</span>
				</div>
			</div>
		</div>
