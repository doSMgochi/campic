...
<body>
	...
	<div class="fixed-box">
		...
		<div class="no-scroll margin-top-30"
			style="text-align: left; overflow-y: scroll; max-height: 77vh;">
						...
						<c:forEach items="${vacances }" var="one">
							<div class="flex-item">
								<a
									...
									class="no-deco"> <img src="${one.imageUrl }"
									onerror="this.src='../campimg.png'" class="camp-img">
									<div>
										...
										<div class="bold-text large-text">${random * 10000}<span
												class="small-text"> 원 부터</span>
										</div>
			...
			<div class="center-text">
				<c:if test="${startPage > 1}">
					<a class="no-deco" href="${currentPath}?p=${startPage - 10}"><button
							class="button-b small-padding">&lt;</button></a>
				</c:if>
					...
					<c:choose>
						...
						<c:otherwise>
							<a class="no-deco" href="${currentPath}?p=${i}"><button
									class="button-b small-padding">${i}</button></a>
						</c:otherwise>
					</c:choose>
				</c:forEach>
